"""
Django settings for NARC project.
...
ALLOWED_HOSTS = ['narc-cheat.herokuapp.com', 'www.byrdof.dev', '127.0.0.1', '192.168.1.89']
...
WSGI_APPLICATION = 'NARC.wsgi.application'
